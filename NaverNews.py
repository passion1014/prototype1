...
RESULT_PATH = 'C:/Users/Dasol/Desktop/ess/crawling_result/'
now = datetime.now() # 파일이름 현 시각으로 저장
...
def get_news (n_url) :
    ...
    title = bsoup.select('h3#articleTitle')[0].text # 대괄호 h3#articleTitle 인 것중 첫번째 그룹만 취득
...
def crawler (maxpage,query,s_date,e_date) :
    ...
    f = open("C:/Users/Dasol/Desktop/ess/crawling_result/contents_text.txt", 'w', encoding='utf-8')
...
def excel_make () :
    ...
    xlsx_outputFileName = 'result_%s_%s_%s_%s_%s_%s.xlsx' % (now.year, now.month, now.day, now.hour, now.minute, now.second)
